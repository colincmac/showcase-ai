...
builder.AddProject<Projects.Showcase_AI_Voice_Agent1>("showcase-ai-voice-agent1");
...
builder.AddProject<Projects.Showcase_AI_Voice_McpServer>("showcase-ai-voice-mcpserver");
